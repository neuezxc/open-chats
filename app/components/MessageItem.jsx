      ...
      >
        <div className="flex flex-row flex-grow items-start gap-3 md:gap-[13px] w-full">
          ...
          <div
            ...
            aria-hidden="true"
          ></div>
          <div className="flex flex-col justify-center items-start gap-[var(--spacing-xs)] w-full max-w-full md:max-w-[80%]">
    ...
    return (
      ...
      >
        <div className="flex self-end w-full justify-end">
          <div className="bg-[var(--user-bubble-bg)] rounded-[var(--border-radius-md)] w-auto max-w-full md:max-w-[80%] p-4">
